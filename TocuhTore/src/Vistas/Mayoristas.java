 ...
 * @author ALBERTO
 */
public class Mayoristas extends javax.swing.JFrame {

    /**
     * Creates new form Mayoristas
     */
    public Mayoristas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Nombre del local :");

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel5.setText("Direccio del local ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mayoristas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Mayoristas().setVisible(true);
            }
        });
    }
